...
package txw.flink.streaming.examples.statemachine.generator;

import txw.flink.streaming.examples.statemachine.dfa.EventTypeAndState;
import txw.flink.streaming.examples.statemachine.dfa.State;
import txw.flink.streaming.examples.statemachine.event.Event;
import txw.flink.streaming.examples.statemachine.event.EventType;
